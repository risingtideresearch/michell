...
midpoint in fleet coordinates (\texttt{FreeWaveSpectrum::amp\_pair}). The
conjugate-and-$-\tfrac{2\nu}\pi\sec^3\theta$ prefactor fixes both magnitude and
phase: it follows Tuck, Scullen \& Lazauskas (2001, 2002) mapped to this crate's
...
\begin{equation}
  ...
  \label{eq:Rspec}
\end{equation}
The integrand $\tfrac12\pi\rho U^{2}|A(\theta)|^{2}\cos^{3}\theta$ is the angular
