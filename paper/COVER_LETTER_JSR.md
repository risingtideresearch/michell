# Draft cover letter — Journal of Ship Research

**Replace every bracketed field before use. Do not send this draft as-is.**
...
that the manuscript and underlying research were substantially drafted with
OpenAI Codex under human direction and validation by the authors.

Both authors have approved this manuscript, and we confirm that it is original,
is not under consideration elsewhere, and has all necessary institutional
approval **[BOTH AUTHORS MUST CONFIRM BEFORE SENDING]**. We have no competing
interests to declare **[CONFIRM OR REPLACE]**.

Thank you for considering the manuscript.

Sincerely,

[CORRESPONDING AUTHOR: ROB STORY OR AVI BRYANT]  
